...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnBuscarCE->Click += gcnew System::EventHandler(this, &CentroEstudiantil::btnBuscarCE_Click);
			// 
			// lblDP
			// 
			...
			this->btnPromo->Click += gcnew System::EventHandler(this, &CentroEstudiantil::btnPromo_Click);
			// 
			// cmbNCE
			// 
			...
			this->lblResult1->Location = System::Drawing::Point(283, 46);
			this->lblResult1->Name = L"lblResult1";
			this->lblResult1->Size = System::Drawing::Size(0, 13);
...
private: System::Void btnBuscarCE_Click(System::Object^ sender, System::EventArgs^ e) {
	//tbxNoACE

	int x;
	x = Convert::ToInt32(tbxNoACE->Text);
	if (x >= 101 && x <= 111) {
		lblResult1->Text = "Su aula se encuentra en el Primer Nivel del Centro Estudiantil";
	}
	else if (x >= 204 && x <= 209) {
		lblResult1->Text = "Su aula se encuentra en el Segundo Nivel del Centro Estudiantil.";
	}

	else {
		lblResult1->Text = "Su aula se encuentra en otro edificio o no existe.";
	}
}
};
}
